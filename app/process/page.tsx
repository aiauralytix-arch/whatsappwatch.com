          ...
          <div className="mt-24 grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="space-y-10">
              ...
              <h1 className="font-[var(--font-space)] text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
                The calm path to a cleaner WhatsApp group.
              </h1>
              <p className="max-w-xl font-[var(--font-plex)] text-lg leading-8 text-[#474747]">
                WhatsApp Watch is designed to feel effortless from the first
                step. You set the tone once, then moderation runs quietly in the
                background while your community stays focused.
              </p>
            ...
            <div className="relative flex flex-col justify-between rounded-3xl border border-[#d5cec3] bg-white/70 p-8 shadow-[var(--shadow-soft)] backdrop-blur">
              ...
              <div className="space-y-6">
                ...
                <p className="font-[var(--font-plex)] text-sm leading-6 text-[#4b4b4b]">
                  Everything you need to go live quickly, without extra tools or
                  complex setup.
                </p>
              </div>
              <div className="space-y-4 text-sm text-[#3c3c3c]">
                {[
                  "Add WhatsApp Watch to your group",
                  "Choose the rules that fit your community",
                  "Let the system run quietly",
                ].map((item) => (
                  <div
                    key={item}
          ...
          <div className="grid gap-10 rounded-[40px] border border-[#cfc7bc] bg-[#fefcf9] px-8 py-12 shadow-[var(--shadow-soft)] lg:grid-cols-[0.7fr_1.3fr]">
            <div className="space-y-6">
              ...
              <h2 className="font-[var(--font-space)] text-3xl font-semibold">
                A clear onboarding flow for every group.
              </h2>
              <p className="font-[var(--font-plex)] text-base leading-7 text-[#4b4b4b]">
                Set up once, then focus on the conversation. The system handles
                the routine moderation, leaving your admins free to lead.
              </p>
            </div>
            <div className="grid gap-6 sm:grid-cols-3">
              {[
                {
                  title: "Step 1",
                  description: "Add WhatsApp Watch to your group in minutes.",
                },
                {
                  title: "Step 2",
                  description: "Choose moderation rules that match your tone.",
                },
                {
                  title: "Step 3",
                  description: "Let it run quietly with zero manual cleanup.",
                },
              ].map((card) => (
                <div
                  key={card.title}
