...
export type DashboardStateSetters = {
  ...
  setAdminNumberInput: React.Dispatch<React.SetStateAction<string>>;
  setAdminNumbers: React.Dispatch<React.SetStateAction<string[]>>;
  setSharedAdminInput: React.Dispatch<React.SetStateAction<string>>;
  setSharedAdminNumbers: React.Dispatch<React.SetStateAction<string[]>>;
